...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_transition-delay.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:28 GMT -->
...
<title>CSS transition-delay 属性</title>
...
<li class="currentLink"><a href="pr_transition-delay.asp" title="CSS transition-delay 属性">transition-delay</a></li>
...
<h1>CSS transition-delay 属性</h1>

<div class="prenextnav">
<ul class="prenext">
<li class="pre"><a href="pr_transition.html" title="CSS transition 属性">transition</a></li>
<li class="next"><a href="pr_transition-duration.asp" title="CSS transition-duration 属性">transition-duration</a></li>
</ul>
</div>
...
<p>HTML DOM 参考手册：<a href="../jsref/prop_style_transitiondelay.html" title="Style transitionDelay 属性">transitionDelay 属性</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t0e5f.html?f=eg_css3_transition-delay">亲自试一试</a></p>
</div>
...
<p>带 -webkit- 或 -moz- 的数字表示使用前缀的首个版本。</p>
...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_transition-delay.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:29 GMT -->
</html>