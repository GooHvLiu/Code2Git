...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_user-select.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:33 GMT -->
...
<title>CSS user-select 属性</title>
...
<li class="currentLink"><a href="pr_user-select.asp" title="CSS user-select 属性">user-select</a></li>
...
<h1>CSS user-select 属性</h1>

<div class="prenextnav">
<ul class="prenext">
<li class="pre"><a href="pr_unicode-bidi.asp" title="CSS unicode-bidi 属性">unicode-bidi</a></li>
<li class="next"><a href="pr_pos_vertical-align.asp" title="CSS vertical-align 属性">vertical-align</a></li>
</ul>
</div>
...
<p>user-select 属性规定是否能选取元素的文本。</p>

<p>在 web 浏览器中，如果您在文本上双击，文本会被选取或高亮显示。此属性用于阻止这种行为。</p>

<h3>另请参阅：</h3>

<p>HTML DOM 参考手册：<a href="../jsref/prop_style_userselect.html" title="Style userSelect 属性">userSelect 属性</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/tfa35.html?f=cssref_user-select">亲自试一试</a></p>
</div>
...
<pre>user-select: auto|none|text|all;</pre>
...
<tr>
<th>动画制作：</th>
<td>不支持。请参阅：<a href="css_animatable.html" title="CSS 动画相关属性">动画相关属性</a>。</td>
</tr>
...
<tr>
<th>JavaScript 语法：</th>
<td>object.style.userSelect=&quot;none&quot;</td>
</tr>
</table>
</div>
...
<p>跟随 -webkit-、-ms- 或 -moz- 的数字规定使用前缀的首个版本。</p>
...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_user-select.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:34 GMT -->
</html>