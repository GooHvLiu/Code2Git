...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_unicode-bidi.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:33 GMT -->
...
<li class="currentLink"><a href="pr_unicode-bidi.asp" title="CSS unicode-bidi 属性">unicode-bidi</a></li>
...
<ul class="prenext">
<li class="pre"><a href="pr_translate.asp" title="CSS translate 属性">translate</a></li>
<li class="next"><a href="pr_user-select.asp" title="CSS user-select 属性">user-select</a></li>
</ul>
</div>
...
<p>unicode-bidi 属性与 direction 属性一起使用，设置或返回是否应重写文本以支持同一文档中的多种语言。</p>

<h3>另请参阅：</h3>

<p>CSS 教程：<a href="../css/css_text.html" title="CSS 文本">CSS 文本</a></p>

<p>HTML DOM 参考手册：<a href="../jsref/prop_style_unicodebidi.html" title="Style unicodeBidi 属性">unicodeBidi 属性</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t6965.html?f=cssref_text_unicode-bidi">亲自试一试</a></p>
</div>
...
<pre>unicode-bidi: normal|embed|bidi-override|initial|inherit;</pre>
...
<tr>
<td>normal</td>
<td>默认值。元素不会打开额外的嵌入级别。</td>
</tr>

<tr>
<td>embed</td>
<td>对于行内元素，此值将打开额外的嵌入级别。</td>
</tr>

<tr>
<td>bidi-override</td>
<td>
	<p>对于行内元素，该值会创建一个覆盖；</p>
	<p>对于块容器元素，该值将为不在另一个块容器元素内的行内级别的后代创建一个覆盖。</p>
</td>
</tr>
...
<tr>
<th>JavaScript 语法：</th>
<td>object.style.unicodeBidi=&quot;bidi-override&quot;</td>
</tr>
</table>
</div>
