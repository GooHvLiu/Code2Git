...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_text_white-space.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:34 GMT -->
...
<li class="currentLink"><a href="pr_text_white-space.asp" title="CSS white-space 属性">white-space</a></li>
...
<ul class="prenext">
<li class="pre"><a href="pr_class_visibility.asp" title="CSS visibility 属性">visibility</a></li>
<li class="next"><a href="pr_widows.asp" title="CSS widows 属性">widows</a></li>
</ul>
</div>
...
<p>HTML DOM 参考手册：<a href="../jsref/prop_style_whitespace.html" title="HTML DOM whiteSpace 属性">whiteSpace 属性</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/tcbdf.html?f=eg_csse_text_white-space">亲自试一试</a></p>
</div>
...
<pre>white-space: normal|nowrap|pre|pre-line|pre-wrap|initial|inherit;</pre>
...
<dl>
<dt><a target="_blank" href="../tiy/tcbdf.html?f=eg_csse_text_white-space">在元素中禁止文本折行</a></dt>
