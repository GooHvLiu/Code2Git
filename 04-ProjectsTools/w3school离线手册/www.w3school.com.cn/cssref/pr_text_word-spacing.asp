...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_text_word-spacing.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:36 GMT -->
...
<li class="currentLink"><a href="pr_text_word-spacing.asp" title="CSS word-spacing 属性">word-spacing</a></li>
...
<ul class="prenext">
<li class="pre"><a href="pr_word-break.asp" title="CSS word-break 属性">word-break</a></li>
<li class="next"><a href="pr_word-wrap.asp" title="CSS word-wrap 属性">word-wrap</a></li>
</ul>
</div>
...
<p>HTML DOM 参考手册：<a href="../jsref/prop_style_wordspacing.html" title="HTML DOM wordSpacing 属性">wordSpacing 属性</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/tf364.html?f=eg_csse_text_word-spacing">亲自试一试</a></p>
</div>
...
<pre>word-spacing: normal|<i>length</i>|initial|inherit;</pre>
...
<dl>
<dt><a target="_blank" href="../tiy/tf364.html?f=eg_csse_text_word-spacing">增加或减少单词间距（字间隔）</a></dt>
