...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_transition-duration.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:29 GMT -->
...
<title>CSS transition-duration 属性</title>
...
<li class="currentLink"><a href="pr_transition-duration.asp" title="CSS transition-duration 属性">transition-duration</a></li>
...
<h1>CSS transition-duration 属性</h1>

<div class="prenextnav">
<ul class="prenext">
<li class="pre"><a href="pr_transition-delay.asp" title="CSS transition-delay 属性">transition-delay</a></li>
<li class="next"><a href="pr_transition-property.asp" title="CSS transition-property 属性">transition-property</a></li>
</ul>
</div>
...
<p>HTML DOM 参考手册：<a href="../jsref/prop_style_transitionduration.html" title="Style transitionDuration 属性">transitionDuration 属性</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t9c1d.html?f=eg_css3_transition-duration">亲自试一试</a></p>
</div>
