...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_class_visibility.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:34 GMT -->
...
<li class="currentLink"><a href="pr_class_visibility.asp" title="CSS visibility 属性">visibility</a></li>
...
<ul class="prenext">
<li class="pre"><a href="pr_pos_vertical-align.asp" title="CSS vertical-align 属性">vertical-align</a></li>
<li class="next"><a href="pr_text_white-space.asp" title="CSS white-space 属性">white-space</a></li>
</ul>
</div>
...
<p>HTML DOM 参考手册：<a href="../jsref/prop_style_visibility.html" title="HTML DOM visibility 属性">visibility 属性</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t7f69.html?f=eg_csse_visibility">亲自试一试</a></p>
</div>
...
<pre>visibility: visible|hidden|collapse|initial|inherit;</pre>
...
<dl>
<dt><a target="_blank" href="../tiy/t7f69.html?f=eg_csse_visibility">如何使元素不可见</a></dt>
<dd>本例演示如何使元素不可见。你希望元素被显示出来，还是不呢？</dd>

<dt><a target="_blank" href="../tiy/tf0b2.html?f=eg_csse_visibility_collapse">把表格元素设置为 collapse</a></dt>
<dd>本例演示如何使表格元素叠加？</dd>
</dl>
</div>
