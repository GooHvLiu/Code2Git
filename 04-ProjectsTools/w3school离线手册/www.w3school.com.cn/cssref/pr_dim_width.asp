...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_dim_width.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:35 GMT -->
...
<li class="currentLink"><a href="pr_dim_width.asp" title="CSS width 属性">width</a></li>
...
<ul class="prenext">
<li class="pre"><a href="pr_widows.asp" title="CSS widows 属性">widows</a></li>
<li class="next"><a href="pr_word-break.asp" title="CSS word-break 属性">word-break</a></li>
</ul>
</div>
...
<p>CSS 教程：<a href="../css/css_dimension.html" title="CSS 尺寸 (Dimension)">CSS 尺寸</a></p>
...
<p class="tiy"><a target="_blank" href="../tiy/t157b.html?f=eg_csse_dim_width">亲自试一试</a></p>
</div>
...
<pre>width: auto|<i>value</i>|initial|inherit;</pre>
...
<dl>
<dt><a target="_blank" href="../tiy/t157b.html?f=eg_csse_dim_width">使用像素值来设置元素的宽度</a></dt>
<dd>本例演示如何使用像素值来设置元素的宽度。</dd>

<dt><a target="_blank" href="../tiy/te227.html?f=eg_csse_dim_width_percent">使用百分比来设置元素的宽度</a></dt>
