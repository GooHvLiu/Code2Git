...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_widows.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:34 GMT -->
...
<li class="currentLink"><a href="pr_widows.asp" title="CSS widows 属性">widows</a></li>
...
<ul class="prenext">
<li class="pre"><a href="pr_text_white-space.asp" title="CSS white-space 属性">white-space</a></li>
<li class="next"><a href="pr_dim_width.asp" title="CSS width 属性">width</a></li>
</ul>
</div>
...
<p><code>widows</code> 属性指定在页面或列的顶部必须保留的最少行数。</p>

<p class="tip"><span>提示：</span>另请参阅 <a href="pr_orphans.html" title="CSS orphans 属性">orphans 属性</a>。</p>
</section>
...
<p>在打印时，每页的底部至少显示 4 行，顶部至少显示 2 行：</p>
