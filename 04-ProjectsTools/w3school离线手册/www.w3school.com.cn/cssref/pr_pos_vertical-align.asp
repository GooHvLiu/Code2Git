...
<!-- Mirrored from www.w3school.com.cn/cssref/pr_pos_vertical-align.asp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2026 05:26:34 GMT -->
...
<li class="currentLink"><a href="pr_pos_vertical-align.asp" title="CSS vertical-align 属性">vertical-align</a></li>
...
<ul class="prenext">
<li class="pre"><a href="pr_user-select.asp" title="CSS user-select 属性">user-select</a></li>
<li class="next"><a href="pr_class_visibility.asp" title="CSS visibility 属性">visibility</a></li>
</ul>
</div>
...
<p>HTML DOM 参考手册：<a href="../jsref/prop_style_verticalalign.html" title="HTML DOM verticalAlign 属性">verticalAlign 属性</a></p>
</div>
...
<p class="tiy"><a target="_blank" href="../tiy/t8653.html?f=eg_csse_vertical-align">亲自试一试</a></p>
</div>
...
<pre>vertical-align: baseline|<i>length</i>|sub|super|top|text-top|middle|bottom|text-bottom|initial|inherit;</pre>
...
<dl>
<dt><a target="_blank" href="../tiy/t8653.html?f=eg_csse_vertical-align">垂直对齐图象</a></dt>
