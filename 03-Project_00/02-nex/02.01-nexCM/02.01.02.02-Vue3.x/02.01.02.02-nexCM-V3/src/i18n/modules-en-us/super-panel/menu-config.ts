...
export default {
  ...
  dialog: {
    ...
    addTitle: 'Add Menu',
    menuId: 'Menu ID',
    menuIdPlaceholder: 'e.g. _105_11',
    menuType: 'Menu Type',
    routeName: 'Route Name',
    routeNamePlaceholder: 'e.g. SuperMenuConfig',
    routePath: 'Route Path',
    routePathPlaceholder: 'e.g. menu-config',
    componentPath: 'Component Path',
    componentPathPlaceholder: 'e.g. super-panel/menu-config/index',
    redirectLabel: 'Redirect',
    redirectPlaceholder: 'e.g. noRedirect',
    titleI18n: 'Menu Title (i18n)',
    titlePlaceholder: 'e.g. layout.menu.superPanel.menuConfig.default',
    iconLabel: 'Icon',
    iconPlaceholder: 'e.g. el-icon-setting',
    sortNo: 'Sort',
    hiddenFlag: 'Hidden',
    alwaysShowFlag: 'Always Show',
    noCacheFlag: 'No Cache',
    parentId: 'Parent Menu ID',
    parentIdPlaceholder: 'Leave empty for top-level, e.g. _105',
    idRequired: 'Please input menu ID',
    nameRequired: 'Please input route name',
    pathRequired: 'Please input route path',
    titleRequired: 'Please input menu title',
    typeRequired: 'Please select menu type'
  },

  // ==================== Runtime Messages ====================
  messages: {
    loadFailed: 'Failed to load menu data',
    enterEdit: 'Entered edit mode',
    confirmExitTitle: 'Confirm Exit',
    noChangesToSave: 'No changes to save',
    saveFailed: 'Save failed',
    saveFailedRetry: 'Save failed, please try again later',
    undone: 'All changes undone',
    refreshed: 'Menu refreshed',
    importBadFormat: 'Invalid file format: missing menuData field',
    importBackupType: 'backup file',
    importExportType: 'export file',
    importConfirm: 'Detected {type}. Importing will overwrite current menu config. Continue?',
    importConfirmTitle: 'Confirm Import',
    importConfirmButton: 'Import',
    importSuccess: 'Menu config imported',
    importFailed: 'Import failed, invalid file format',
    updated: 'Menu updated, takes effect after saving',
    added: 'Menu added, takes effect after saving',
    markedDeleted: 'Menu marked for deletion, takes effect after saving',
    reordered: 'Menu order adjusted, takes effect after saving',
    topMenu: 'Top Menu'
  },
