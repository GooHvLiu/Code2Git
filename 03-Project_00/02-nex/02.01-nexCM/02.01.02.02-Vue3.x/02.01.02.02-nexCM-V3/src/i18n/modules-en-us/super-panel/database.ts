...
export default {
  ...
  messages: {
    ...
    folderSelected: 'Folder selected: {name}, please complete the full path manually',
    pathRequired: 'Please input storage path',
    pathChanged: 'Storage path updated'
  },
