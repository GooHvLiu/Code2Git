// @ts-nocheck
// 全球城市坐标数据（框架无关，迁移自 Vue2，作者：GooHv）
/**
 * 全球主要城市数据
 * 结构：国家 -> 城市列表
...
export const worldCities = [
  // ==================== 亚洲 Asia ====================
  {
    ...
    nameEn: 'China',
    cities: [
      { code: 'CN-WX', nameZh: '无锡', nameEn: 'Wuxi', lng: 120.3, lat: 31.57 },
      { code: 'CN-SH', nameZh: '上海', nameEn: 'Shanghai', lng: 121.47, lat: 31.23 },
      { code: 'CN-BJ', nameZh: '北京', nameEn: 'Beijing', lng: 116.4, lat: 39.9 },
      ...
      { code: 'CN-TJ', nameZh: '天津', nameEn: 'Tianjin', lng: 117.2, lat: 39.13 },
      ...
      { code: 'CN-MO', nameZh: '澳门', nameEn: 'Macau', lng: 113.55, lat: 22.2 },
  ...
  },
  {
    ...
    cities: [
      ...
      { code: 'JP-OSA', nameZh: '大阪', nameEn: 'Osaka', lng: 135.5, lat: 34.69 },
      ...
      { code: 'JP-KOB', nameZh: '神户', nameEn: 'Kobe', lng: 135.2, lat: 34.69 },
      { code: 'JP-FUK', nameZh: '福冈', nameEn: 'Fukuoka', lng: 130.4, lat: 33.59 },
  ...
  },
  {
    ...
    cities: [
      ...
      { code: 'KR-BUS', nameZh: '釜山', nameEn: 'Busan', lng: 129.04, lat: 35.1 },
      { code: 'KR-ICN', nameZh: '仁川', nameEn: 'Incheon', lng: 126.7, lat: 37.46 },
      { code: 'KR-DAE', nameZh: '大邱', nameEn: 'Daegu', lng: 128.6, lat: 35.87 },
  ...
  },
  {
    ...
    nameZh: '新加坡',
    nameEn: 'Singapore',
    cities: [{ code: 'SG-SIN', nameZh: '新加坡', nameEn: 'Singapore', lng: 103.82, lat: 1.35 }]
  },
  {
    code: 'MY',
    nameZh: '马来西亚',
  ...
  },
  {
    ...
    nameEn: 'Thailand',
    cities: [
      { code: 'TH-BKK', nameZh: '曼谷', nameEn: 'Bangkok', lng: 100.5, lat: 13.75 },
  ...
  },
  {
    ...
    nameZh: '菲律宾',
    nameEn: 'Philippines',
    cities: [{ code: 'PH-MNL', nameZh: '马尼拉', nameEn: 'Manila', lng: 120.98, lat: 14.6 }]
  },
  {
    code: 'IN',
    nameZh: '印度',
  ...
  },
  {
    ...
    nameEn: 'UAE',
    cities: [
      { code: 'AE-DXB', nameZh: '迪拜', nameEn: 'Dubai', lng: 55.27, lat: 25.2 },
  ...
  // ==================== 欧洲 Europe ====================
  {
    ...
    nameEn: 'Germany',
    cities: [
      { code: 'DE-BER', nameZh: '柏林', nameEn: 'Berlin', lng: 13.4, lat: 52.52 },
  ...
  },
  {
    ...
    cities: [
      ...
      { code: 'GB-BIR', nameZh: '伯明翰', nameEn: 'Birmingham', lng: -1.9, lat: 52.48 },
  ...
  },
  {
    ...
    cities: [
      ...
      { code: 'FR-MAR', nameZh: '马赛', nameEn: 'Marseille', lng: 5.37, lat: 43.3 },
      { code: 'FR-LYO', nameZh: '里昂', nameEn: 'Lyon', lng: 4.84, lat: 45.76 },
      { code: 'FR-TLS', nameZh: '图卢兹', nameEn: 'Toulouse', lng: 1.44, lat: 43.6 },
  ...
  },
  {
    ...
    nameEn: 'Italy',
    cities: [
      { code: 'IT-ROM', nameZh: '罗马', nameEn: 'Rome', lng: 12.5, lat: 41.9 },
  ...
  },
  {
    ...
    nameEn: 'Spain',
    cities: [
      { code: 'ES-MAD', nameZh: '马德里', nameEn: 'Madrid', lng: -3.7, lat: 40.42 },
  ...
  },
  {
    ...
    nameEn: 'Netherlands',
    cities: [
      { code: 'NL-AMS', nameZh: '阿姆斯特丹', nameEn: 'Amsterdam', lng: 4.9, lat: 52.37 },
  ...
  },
  {
    ...
    cities: [
      ...
      { code: 'BE-ANR', nameZh: '安特卫普', nameEn: 'Antwerp', lng: 4.4, lat: 51.22 }
    ]
  },
  {
    code: 'CH',
    ...
    cities: [
      ...
      { code: 'CH-GVA', nameZh: '日内瓦', nameEn: 'Geneva', lng: 6.14, lat: 46.2 },
  ...
  },
  {
    ...
    nameZh: '挪威',
    nameEn: 'Norway',
    cities: [{ code: 'NO-OSL', nameZh: '奥斯陆', nameEn: 'Oslo', lng: 10.75, lat: 59.91 }]
  },
  {
    code: 'DK',
    nameZh: '丹麦',
    nameEn: 'Denmark',
    cities: [{ code: 'DK-CPH', nameZh: '哥本哈根', nameEn: 'Copenhagen', lng: 12.57, lat: 55.68 }]
  },
  {
    code: 'FI',
    nameZh: '芬兰',
    nameEn: 'Finland',
    cities: [{ code: 'FI-HEL', nameZh: '赫尔辛基', nameEn: 'Helsinki', lng: 24.94, lat: 60.17 }]
  },
  {
    code: 'PL',
    nameZh: '波兰',
  ...
  },
  {
    ...
    cities: [{ code: 'CZ-PRG', nameZh: '布拉格', nameEn: 'Prague', lng: 14.42, lat: 50.08 }]
  },
  {
    code: 'HU',
    nameZh: '匈牙利',
    nameEn: 'Hungary',
    cities: [{ code: 'HU-BUD', nameZh: '布达佩斯', nameEn: 'Budapest', lng: 19.04, lat: 47.5 }]
  },
  {
    code: 'PT',
    nameZh: '葡萄牙',
  ...
  },
  {
    ...
    nameZh: '希腊',
    nameEn: 'Greece',
    cities: [{ code: 'GR-ATH', nameZh: '雅典', nameEn: 'Athens', lng: 23.73, lat: 37.98 }]
  },
  {
    code: 'RU',
    nameZh: '俄罗斯',
  ...
  },
  {
    ...
    nameZh: '乌克兰',
    nameEn: 'Ukraine',
    cities: [{ code: 'UA-KBP', nameZh: '基辅', nameEn: 'Kyiv', lng: 30.52, lat: 50.45 }]
  },
  ...
  // ==================== 北美洲 North America ====================
  {
    ...
    cities: [
      { code: 'US-NYC', nameZh: '纽约', nameEn: 'New York', lng: -74.0, lat: 40.71 },
      ...
      { code: 'US-DAL', nameZh: '达拉斯', nameEn: 'Dallas', lng: -96.8, lat: 32.78 },
      ...
      { code: 'US-CLE', nameZh: '克利夫兰', nameEn: 'Cleveland', lng: -81.69, lat: 41.5 },
  ...
  },
  {
    ...
    nameEn: 'Argentina',
    cities: [
      { code: 'AR-BUE', nameZh: '布宜诺斯艾利斯', nameEn: 'Buenos Aires', lng: -58.38, lat: -34.6 },
  ...
  },
  {
    ...
    nameZh: '智利',
    nameEn: 'Chile',
    cities: [{ code: 'CL-SCL', nameZh: '圣地亚哥', nameEn: 'Santiago', lng: -70.67, lat: -33.45 }]
  },
  {
    code: 'CO',
    nameZh: '哥伦比亚',
  ...
  },
  {
    ...
    nameZh: '秘鲁',
    nameEn: 'Peru',
    cities: [{ code: 'PE-LIM', nameZh: '利马', nameEn: 'Lima', lng: -77.04, lat: -12.05 }]
  },
  ...
  // ==================== 非洲 Africa ====================
  {
    ...
    nameEn: 'South Africa',
    cities: [
      { code: 'ZA-JNB', nameZh: '约翰内斯堡', nameEn: 'Johannesburg', lng: 28.05, lat: -26.2 },
  ...
  },
  {
    ...
    cities: [
      ...
      { code: 'EG-ALY', nameZh: '亚历山大', nameEn: 'Alexandria', lng: 29.92, lat: 31.2 }
    ]
  },
  {
    code: 'NG',
  ...
  },
  {
    ...
    nameZh: '肯尼亚',
    nameEn: 'Kenya',
    cities: [{ code: 'KE-NBO', nameZh: '内罗毕', nameEn: 'Nairobi', lng: 36.82, lat: -1.29 }]
  },
  {
    code: 'MA',
    nameZh: '摩洛哥',
  ...
  // ==================== 大洋洲 Oceania ====================
  {
    ...
    cities: [
      ...
      { code: 'AU-ADE', nameZh: '阿德莱德', nameEn: 'Adelaide', lng: 138.6, lat: -34.93 },
