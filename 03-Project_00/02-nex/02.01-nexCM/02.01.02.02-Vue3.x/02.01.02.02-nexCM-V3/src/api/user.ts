 ...
 */
export function requestGetUserListApi(params: Record<string, unknown>) {
 ...
 */
export function requestGetUserDetailApi(id: string) {
 ...
 */
export function requestAddUserApi(data: Record<string, unknown>) {
 ...
 */
export function requestUpdateUserApi(data: Record<string, unknown>) {
  const { id, ...body } = data
 ...
 * @param {number|string} id - 用户ID
 */
export function requestDeleteUserApi(id: string) {
 ...
 */
export function requestResetUserPwdApi(id: string, newPassword: string) {
 ...
 * @param {number|string} id - 用户ID
 */
export function requestUnlockUserApi(id: string) {
 ...
 */
export function requestSendResetCodeApi(data: Record<string, unknown>) {
 ...
 */
export function requestResetPasswordByCodeApi(data: Record<string, unknown>) {
