 ...
 */
export function requestGetRoleMenuIdsApi(roleId: string) {
 ...
 */
export function requestSaveRolePermissionsApi(data: Record<string, unknown>) {
 ...
 * @returns {Promise<{code:number, msg:string, data:{success:boolean}}>}
 */
export function requestClearUserCacheApi(data: Record<string, unknown>) {
