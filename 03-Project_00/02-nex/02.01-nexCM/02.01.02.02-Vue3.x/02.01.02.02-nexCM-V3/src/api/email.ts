 ...
 */
export function requestGetEmailConfigListApi(params: Record<string, unknown>) {
 ...
 */
export function requestGetEmailConfigDetailApi(id: string) {
 ...
 */
export function requestCreateEmailConfigApi(data: Record<string, unknown>) {
 ...
 */
export function requestUpdateEmailConfigApi(id: string, data: Record<string, unknown>) {
 ...
 * @returns {Promise<Object>}
 */
export function requestDeleteEmailConfigApi(id: string) {
 ...
 * @returns {Promise<Object>}
 */
export function requestSetDefaultEmailConfigApi(id: string) {
 ...
 * @returns {Promise<Object>}
 */
export function requestUpdateEmailConfigStatusApi(id: string, status: string) {
 ...
 * @returns {Promise<Object>}
 */
export function requestSendTestEmailApi(data: Record<string, unknown>) {
 ...
 * @returns {Promise<Object>}
 */
export function requestVerifySmtpConnectionApi(data: Record<string, unknown>) {
 ...
 * @returns {Promise<Object>} { list, total }
 */
export function requestGetEmailLogListApi(params: Record<string, unknown>) {
 ...
 */
export function requestGetEmailLogDetailApi(id: string) {
 ...
 * @returns {Promise<Object>}
 */
export function requestDeleteEmailLogApi(id: string) {
