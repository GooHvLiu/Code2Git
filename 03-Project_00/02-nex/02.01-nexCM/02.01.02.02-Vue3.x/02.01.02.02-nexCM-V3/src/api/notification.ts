 ...
 */
export function requestGetNotificationListApi(params: Record<string, unknown>) {
  return request({ url: '/notification/', method: 'get', params })
}

/** 获取通知详情 */
export function requestGetNotificationApi(id: string) {
...
/** 标记为已读 */
export function requestMarkAsReadApi(id: string) {
...
/** 删除通知 */
export function requestDeleteNotificationApi(id: string) {
 ...
 */
export function requestUpdateNotificationSettingsApi(settings: Record<string, unknown>) {
