 ...
 */
export function requestGetFeatureConfigByCategoryApi(category: string) {
 ...
 */
export function requestGetFeatureConfigApi(featureKey: string) {
 ...
 * @returns {Promise<{code:number, msg:string, data:Object}>}
 */
export function requestUpdateFeatureConfigApi(featureKey: string, value: unknown) {
 ...
 */
export function requestBatchUpdateFeatureConfigApi(updates: Record<string, unknown>) {
 ...
 * @returns {Promise<{code:number, msg:string, data:Object}>}
 */
export function requestResetFeatureConfigApi(featureKey: string) {
 ...
 */
export function requestResetCategoryFeatureConfigApi(category: string) {
 ...
 */
export function requestCheckFeatureEnabledApi(featureKey: string) {
