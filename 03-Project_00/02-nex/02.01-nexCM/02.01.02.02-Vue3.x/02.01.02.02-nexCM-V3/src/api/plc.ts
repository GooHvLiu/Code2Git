 ...
 */
export function requestGetPlcStatusApi(device: string) {
 ...
 */
export function requestReconnectPlcApi(device: string) {
 ...
 */
export function requestReadPlcTagApi(tag: string, device: string) {
 ...
 */
export function requestReadAllPlcTagsApi(device: string) {
  const params = device ? { device } : {}
 ...
 */
export function requestWritePlcTagApi(data: Record<string, unknown>) {
