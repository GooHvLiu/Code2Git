 ...
 * @returns {Promise<{code:number, msg:string, data:Array}>}
 */
export function requestGetTableStructureApi(tableName: string) {
 ...
 */
export function requestUpdateTableDataApi(tableName: string, data: Record<string, unknown>, where: string) {
  return request({
    url: `/db-manager/tables/${tableName}/data`,
    method: 'put',
    data: { data, where }
 ...
 * @returns {Promise<{code:number, msg:string, data:object}>}
 */
export function requestInsertTableDataApi(tableName: string, data: Record<string, unknown>) {
  return request({
    url: `/db-manager/tables/${tableName}/data`,
    method: 'post',
    data: { data }
 ...
 * @returns {Promise<{code:number, msg:string, data:object}>}
 */
export function requestDeleteTableDataApi(tableName: string, where: string) {
  return request({
    url: `/db-manager/tables/${tableName}/data`,
    method: 'delete',
    data: { where }
 ...
 * @returns {Promise<{code:number, msg:string, data:object}>}
 */
export function requestGetBackupByIdApi(id: string) {
 ...
 */
export function requestDeleteBackupApi(id: string) {
 ...
 */
export function requestRestoreBackupApi(id: string) {
