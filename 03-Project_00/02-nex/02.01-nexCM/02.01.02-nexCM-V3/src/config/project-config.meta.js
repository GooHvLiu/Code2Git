...
export const SOURCE_TYPE_CONFIG = {
  [SOURCE_TYPE.FILE]: {
    ...
    labelKey: 'superPanel.projectConfig.sourceType.file'
  },
  [SOURCE_TYPE.DATABASE]: {
    icon: 'el-icon-coin',
    labelKey: 'superPanel.projectConfig.sourceType.database'
  },
  [SOURCE_TYPE.RUNTIME]: {
    icon: 'el-icon-monitor',
    labelKey: 'superPanel.projectConfig.sourceType.runtime'
  },
  [SOURCE_TYPE.CODE]: {
    icon: 'el-icon-code',
    labelKey: 'superPanel.projectConfig.sourceType.code'
  }
}
