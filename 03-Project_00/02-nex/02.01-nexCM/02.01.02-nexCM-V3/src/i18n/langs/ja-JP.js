 ...
 * 请勿手动修改此文件，除非您了解其结构
 * 
 * 最后更新时间: 2026-09-08T04:05:43.962Z
 */
...
export default {
  ...
  quickMenu: {
    ...
    theme: {
      ...
      custom: 'カスタム化。',
      sidebarBg: 'サイドバーの背景',
      sidebarHoverText: 'サイドバー文字のロールオーバー',
      sidebarHoverBg: 'サイドバー背景のホバー',
      sidebarIconColor: 'アイコンの色',
      sidebarActiveBg: 'サイドバー Backgroundのアクティブ化'
    },
    language: {
      title: '言語は',
      switchedToZh: '中国語に切り替えた。',
      switchedToEn: '英語に切り替えた。',
      switched: '{lang}に切り替えました',
      switchFailed: '言語の切り替え失敗'
    }
  },
  notification: {
    title: '通知中心',
  ...
  theme: {
    sidebarBg: 'サイドバーの背景色',
    sidebarHoverText: 'サイドバーのカーソルの文字色の移動',
    sidebarHoverBg: 'サイドバーの背景色をする',
    sidebarIconColor: 'サイドバーアイコンの色',
    sidebarActiveBg: 'サイドバー Background Colorをチェック'
  },
  errorPage: {
    back: '返回',
    backHome: '返回首页',
  ...
  license: {
    ...
    detailTitle: '認可の詳細',
    download: 'ダウンロードダウンロード',
    dragUpload: 'ライセンスファイルをここにドラッグするか、アップロードをクリックします。',
    email: 'メールボックス',
    enabled: '有効化された',
    expireAt: '有効期限は',
    expireTime: '有効期限',
    ...
    importDialogTitle: '認可のインポート',
    importLicense: '認可のインポート',
    importNewLicense: '新規認可のインポート',
    importTip: '.lic形式の承認ファイルを選択してください',
    issuedAt: '発行時期のお知らせ',
    lastModified: '最終修正の時間',
    lastVerified: '最終検証の時間',
    licenseId: '認証id',
    licenseStatus: '認可ステータス',
    licenseType: '認可の種類',
    manageTitle: '権限委譲管理',
    matchStatus: '一致のステータス',
    matched: 'マッチした。',
    maxDevices: '機器の最大数',
    maxUsers: '最大ユーザー数',
    noLicenseFile: '認証ファイルが見つかりませんでした',
    notInitialized: '初期化されない',
    notMatched: 'マッチしない。',
    phone: '電話で。',
    project: 'プロジェクトプロジェクト#',
    projectId: 'プロジェクトid',
    projectName: 'プロジェクト名',
    refresh: 'リフレッシュする。',
    serverTime: 'サーバーの時間',
    statusInvalid: 'ステータスが無効です',
    statusValid: 'ステータスは有効です。',
    syncTime: '同期時間',
    timeGuard: '時間を守る。',
    timeGuardStatus: '時間を守る。',
    timeRemaining: '残り時間は',
    unknownReason: '原因不明。',
    unlimited: '制限なし。'
  },
  systemConfig: {
    device: {
      reminderContent: 'リマインダーの内容',
      reminderNoData: 'データのリマインダーなし',
      reminderRemindLater: '後で思い出す。',
      reminderTitle: '部品寿命のリマインダー',
      reminderViewDetail: '詳細はこちら'
    }
  }
}
