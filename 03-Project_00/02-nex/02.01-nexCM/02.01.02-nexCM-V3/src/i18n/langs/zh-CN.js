...
export default {
  ...
  systemConfig: {
    ...
    device: {
      ...
      deviceCode: '设备编号',
      deviceRegion: '所在地区',
      deviceInstallDate: '投用日期',
      partLifeSettingsTitle: '部件寿命提醒设置',
      partLifeReminderEnabled: '部件寿命提醒',
      partLifeReminderEnabledTip: '开启后，部件寿命达到阈值时自动弹出提醒',
      partLifeThreshold: '提前提醒阈值',
      partLifeThresholdTip: '剩余寿命达到此比例时开始提醒',
      partLifeRemindInterval: '提醒频率',
      partLifeRemindIntervalTip: '寿命到期后按此频率弹出警告提醒，弹窗可拖拽、可关闭',
      snoozeInterval: '稍后提醒间隔',
      snoozeIntervalTip: '点击"稍后提醒"后，按此间隔时间再次弹出提醒',
      snooze5min: '5分钟',
      snooze10min: '10分钟',
      snooze30min: '30分钟',
      snooze1hour: '1小时',
      ...
      reminderContent: '以下部件寿命已达到提醒阈值，请及时更换：',
      reminderNoData: '当前无需要提醒的部件'
    },
    order: {
      title: '订单设置',
