 ...
 *
 * 默认值策略：
 *   - 与 theme-variables.config.js 共享的字段（sidebar-bg / sidebar-hover-bg），
 *     默认值从 theme-variables.config.js 读取，确保编译时和运行时一致
 *   - 其他字段保持写死默认值
 *   - initTheme 只恢复 localStorage 中用户主动切换过的值，
 *     未切换过的字段不设置 CSS 变量，让编译时的默认值生效
 *
 * 用法：
 * import { setThemeField, getThemeField, initTheme, THEME_FIELDS } from '@/utils/ui/theme'
 ...
 * varName: 对应的 CSS 变量名
 * default: 默认值（与 variables.less / theme-variables.config.js 保持一致）
 * hasLight: 是否需要自动计算浅色变体（仅主题色需要）
 */
export const THEME_FIELDS = [
  {
    key: 'sidebarBg',
    get label() { return i18n.t('layout.quickMenu.theme.sidebarBg') },
    varName: '--sidebar-bg',
    default: themeVariables['sidebar-bg']
  },
  {
    key: 'sidebarHoverText',
    get label() { return i18n.t('layout.quickMenu.theme.sidebarHoverText') },
    varName: '--sidebar-hover-text',
    default: themeVariables['sidebar-hover-text']
  },
  {
    key: 'sidebarHoverBg',
    get label() { return i18n.t('layout.quickMenu.theme.sidebarHoverBg') },
    varName: '--sidebar-hover-bg',
    default: themeVariables['sidebar-hover-bg']
  },
  {
    key: 'sidebarIconColor',
    get label() { return i18n.t('layout.quickMenu.theme.sidebarIconColor') },
    varName: '--sidebar-icon-color',
    default: themeVariables['sidebar-icon-color']
  },
  {
    key: 'sidebarActiveBg',
    get label() { return i18n.t('layout.quickMenu.theme.sidebarActiveBg') },
