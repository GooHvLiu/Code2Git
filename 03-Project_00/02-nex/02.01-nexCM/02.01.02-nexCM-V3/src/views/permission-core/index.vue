...
const props = defineProps({
  ...
  titleKey: {
    type: String,
    default: "system.permission.page.title",
  },
  // 描述 i18n key
  descKey: {
    type: String,
    default: "system.permission.page.desc",
  },
  // 保存成功提示 i18n key
  saveSuccessKey: {
    type: String,
    default: "system.permission.page.saveSuccess",
  },
});
...
function getTypeName(type) {
  const map = {
    menu: i18n.t("system.permission.page.menu"),
    button: i18n.t("system.permission.page.button"),
    param: i18n.t("system.permission.page.param"),
  };
