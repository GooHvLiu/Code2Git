        ...
        <div class="dashboard-content">
            ...
            <el-col :span="6" v-for="(stat, index) in alarmStats" :key="index">
              <div class="stat-card" :class="stat.type">
                ...
                <div class="stat-info">
                  ...
                  <div class="stat-value">{{ stat.value }}<span class="stat-unit">次</span></div>
          ...
          <el-row :gutter="12" class="charts-row">
            ...
            <el-col :span="8">
              <div class="chart-panel">
                <div class="panel-header">
                  <span class="panel-title"><i class="el-icon-pie-chart"></i> 报警类别分布</span>
                </div>
            ...
            <el-col :span="10">
              <div class="chart-panel">
                <div class="panel-header">
                  <span class="panel-title"><i class="el-icon-line-chart"></i> 近7天报警趋势</span>
                </div>
                <div class="panel-body">
            ...
            <el-col :span="6">
              <div class="chart-panel">
                <div class="panel-header">
                  <span class="panel-title"><i class="el-icon-data-analysis"></i> 报警级别</span>
                </div>
                <div class="panel-body">
                  <div class="level-list">
                    <div class="level-item" v-for="(item, index) in levelData" :key="index">
          ...
          <el-row :gutter="12" class="top-row">
            <el-col :span="24">
              <div class="chart-panel">
                <div class="panel-header">
                  <span class="panel-title"><i class="el-icon-rank"></i> 报警类型 TOP5</span>
                  <span class="panel-subtitle">近30天</span>
                </div>
                <div class="panel-body">
                  <div class="top-list">
                    <div class="top-item" v-for="(item, index) in topAlarms" :key="index">
        ...
        <div class="list-content">
          ...
          <div class="search-section">
            <el-form :inline="true" :model="searchForm" class="search-form">
              ...
              <el-form-item label="关键词">
                <el-input v-model="searchForm.keyword" placeholder="报警描述/设备编号" clearable style="width: 180px" />
              </el-form-item>
              <el-form-item>
          ...
          <div class="table-section">
            ...
            >
              ...
              <el-table-column prop="alarmNo" label="报警编号" width="140" align="center" />
              <el-table-column prop="alarmTime" label="报警时间" width="160" align="center" />
              <el-table-column label="报警级别" width="90" align="center">
                <template slot-scope="scope">
                  <el-tag :type="getLevelType(scope.row.level)" size="small" effect="plain">
              ...
              <el-table-column prop="alarmCode" label="报警代码" width="100" align="center" />
              <el-table-column prop="description" label="报警描述" min-width="200" show-overflow-tooltip />
              <el-table-column prop="deviceCode" label="设备编号" width="140" align="center" />
              ...
              <el-table-column prop="resolveTime" label="处理时间" width="160" align="center" />
              <el-table-column label="操作" width="100" align="center" fixed="right">
                <template slot-scope="scope">
                  <el-button type="text" size="small" @click="handleDetail(scope.row)">详情</el-button>
                  <el-button type="text" size="small" @click="handleResolve(scope.row)" v-if="scope.row.status !== 'resolved'">处理</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
...
.stat-card {
  ...
  .stat-info {
    ...
    .stat-value {
      ...
      .info & { color: #409eff; }
      .stat-unit { font-size: 12px; color: #909399; margin-left: 4px; font-weight: normal; }
    }
    .stat-trend {
      font-size: 11px;
      margin-top: 2px;
...
.category-chart {
  ...
  .category-legend {
    ...
    .legend-item {
      ...
      .legend-count { color: #303133; font-weight: 600; margin-right: 8px; }
...
.top-list {
  .top-item {
    ...
    .top-info {
      width: 200px;
      margin-right: 14px;
      .top-name { font-size: 13px; font-weight: 600; color: #303133; margin-bottom: 2px; }
      .top-desc { font-size: 11px; color: #909399; }
    }
    .top-bar {
      flex: 1;
      height: 8px;
