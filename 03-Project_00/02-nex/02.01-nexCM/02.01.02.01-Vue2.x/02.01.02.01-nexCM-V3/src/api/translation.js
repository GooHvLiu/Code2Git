 ...
 */
export function requestSaveTranslationConfigApi(config) {
  return request({
 ...
 */
export function requestTranslateApi(text, source, target) {
  return request({
 ...
 * @param {string} target - 目标语言编码
 */
export function requestTranslateBatchApi(items, source, target) {
  return request({
