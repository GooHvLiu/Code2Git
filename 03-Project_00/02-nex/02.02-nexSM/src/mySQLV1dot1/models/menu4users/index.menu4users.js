...
class Menu4usersBase {
  constructor(dbName, menu_TableName, menu4userTableName) {
    this.dbName = dbName;
    this.menu_TableName = menu_TableName;
    this.menu4userTableName = menu4userTableName;
  }
   ...
   */
  async findUserMenuTree(id, dbName, menuTable, userTable) {
    try {
