...
* <span style="color:#black;font-weight:normal;font-family:'楷体">1.1_01版本基于实际项目更新：</span>
  * <span style="color:#black;font-weight:normal;font-family:'楷体">中间件增加鉴权模块：</span>
...
```bash
npm i dotenv dotenv-expand mysql2 module-alias jsonwebtoken
```
