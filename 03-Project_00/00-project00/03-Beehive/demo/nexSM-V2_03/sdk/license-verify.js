...
class LicenseVerifier {
   ...
   * @param {string} [options.aesKey] AES密钥（必须与服务端一致）
   * @param {string} [options.aesIv] AES IV（必须与服务端一致）
  ...
  constructor(options = {}) {
    ...
    this.aesKey = options.aesKey || 'BeehiveTools@2024#AES256Key!';
    this.aesIv = options.aesIv || 'BeehiveIV@2024!';
