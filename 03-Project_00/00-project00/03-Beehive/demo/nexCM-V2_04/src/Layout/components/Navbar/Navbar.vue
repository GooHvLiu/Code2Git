      ...
      <div class="navbar-right">
        ...
        <el-dropdown @command="handleCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item v-if="isAdmin" command="userManagement">{{ $t('layout.userManagement') }}</el-dropdown-item>
            <el-dropdown-item command="auditLog">{{ $t('layout.auditLog') }}</el-dropdown-item>
