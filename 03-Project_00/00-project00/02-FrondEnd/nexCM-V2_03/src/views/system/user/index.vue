<template>
  <div class="user-management">
    ...
    >
      ...
      <el-table-column :label="$t('user.realName')" prop="real_name" min-width="100" />
      ...
      <el-table-column :label="$t('user.createTime')" prop="create_time" min-width="160" sortable="custom" />
